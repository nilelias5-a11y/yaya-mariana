...
const ICONS = [
  ...
  <svg key="leaf" aria-hidden viewBox="0 0 24 24" fill="none" stroke="var(--color-brand-primary)" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
    <path d="M12 22V12" />
    <path d="M12 12C12 7 7 3 3 3c0 5 3 9 9 9z" />
    <path d="M12 12c0-5 5-9 9-9-0 5-3 9-9 9z" />
  </svg>,
  // Hidratación — gota de agua
  <svg key="drop" aria-hidden viewBox="0 0 24 24" fill="none" stroke="var(--color-brand-primary)" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
    <path d="M12 2C12 2 5 10 5 15a7 7 0 0 0 14 0c0-5-7-13-7-13z" />
  </svg>,
  // Cero pesticidas — escudo con check
  <svg key="shield" aria-hidden viewBox="0 0 24 24" fill="none" stroke="var(--color-brand-primary)" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
    <polyline points="9 12 11 14 15 10" />
  </svg>,
  // Huella mínima — hoja con círculo
  <svg key="eco" aria-hidden viewBox="0 0 24 24" fill="none" stroke="var(--color-brand-primary)" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
  ...
  <svg key="heart" aria-hidden viewBox="0 0 24 24" fill="none" stroke="var(--color-brand-primary)" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
  </svg>,
  // Sabor intenso — estrella
  <svg key="star" aria-hidden viewBox="0 0 24 24" fill="none" stroke="var(--color-brand-primary)" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
