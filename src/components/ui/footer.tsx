...
export default function Footer() {
  ...
  return (
    ...
    <footer className="relative bg-[#2d0a0a] text-white pt-16 pb-8 px-6">
        ...
        >
          ...
          <div className="md:col-span-1">
            ...
            >
              ...
              <span
                className="block font-serif italic text-white/55 text-[0.95rem] mb-4"
            ...
            <div className="flex items-center gap-3 mt-5">
              {SOCIALS.map(({ label, href, icon }) => (
                <a
                  ...
                  className="group/social w-8 h-8 rounded-full bg-white/10 hover:bg-[#c0392b] focus-visible:bg-[#c0392b] flex items-center justify-center transition-all duration-200 outline-none"
                  style={{
